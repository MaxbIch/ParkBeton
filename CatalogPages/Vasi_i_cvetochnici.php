...
<body>
    ...
    <div class="cart">
        <div class="cart-content">
            ...
            $mysqli->query($query);
            $query = "select * from Vasi_i_cvetochnici";
    ...
    <footer>
      <div class="footer-content" id="Kat">
        ...
        <div class="footers-pages">
          ...
          <div class="footers-pages-item"><img src="../Images/arrow-roght.svg" alt="Стрелка"><a href="../AboutUs.html#id_questions-section"></a>Покупателям</div>
