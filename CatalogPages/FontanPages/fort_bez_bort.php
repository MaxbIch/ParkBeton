...
<body>
    ...
    <section class="navigation-section">
        <div class="navigation-section-item">
            ...
            <a class="cat-arrow"></a>
            <a href="#">Фонтаны из бетона без бассейнов (бортиков) </a>
        </div>
    </section>

    <section class="category-info">
        <div class="category-info-tittle">Фонтаны</div>
        <div class="category-info-content">
            <div class="category-info-image">
                <img src="/Images/Fontans/f6.webp" alt="Фонтан">
            </div>
            <div class="category-info-text">
                Среди разнообразных ландшафтных решений фонтан из бетона занимает лидирующие позиции по красоте и практичности. В статье рассказывается о достоинствах и недостатках конструкций бетонных изделий, а также об их типах. Вы познакомитесь с особенностями архитектурного бетона, тонкостями выбора элементов садовой архитектуры и этапами установки; узнаете, какие факторы определяют стоимость той или иной модели.
            </div>
        </div>
    </section>
    ...
    <div class="cart">
     <div class="cart-content">
         <?php
            ...
            $mysqli->query($query);
            $query = "select * from fort_bez_bort";
